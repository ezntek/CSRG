...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{cpus.png}
...
RAM or Random Access Memory; otherwise referred to as just Memory, stores \emph{volatile data} that does not have tobe on your hard drive. It only stores data that the computer. Examples of data that goes into memory include temporary values that programs must store; from simple integers to browser tabs.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{ram.png}
