...
\definecolor{blue}{HTML}{206ac9}
\definecolor{green}{HTML}{22b625}
\definecolor{yellow}{HTML}{ffb206}
\definecolor{linkblue}{mix}{80,blue,white}
...
\subfile{chapters/7_algorithms_and_problem_solving.tex}

\chapter{Programming}
\subfile{chapters/8_programming.tex}

\chapter{Databases}
\subfile{chapters/9_databases.tex}

\chapter{Boolean Logic}
\subfile{chapters/10_boolean_logic}
